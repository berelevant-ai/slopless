...
Prepared Slopless for transfer from its previous GitHub organization to
...
- Created the `berelevant-ai/.github` organization profile repository with minimal Slopless-oriented public copy.
...
- Transfer the GitHub repository to `berelevant-ai/slopless`.
- Set local `origin` to `https://github.com/berelevant-ai/slopless.git`.
- Push `development` to the new remote.
- Run `.plans/verify-2026-05-21-114145-berelevant-ai-migration.sh`.
